...
if args.amfi11:
	...
	fh = kernel_file
	file = fh.read()
	hex_value = hex(file.index(b"\xF8\x5F\xBC\xA9\xF6\x57\x01\xA9\xF4\x4F\x02")) #Finding pattern
...
if args.amfi12:
	...
	fh = kernel_file
	file = fh.read()
	hex_value = hex(file.index(b"\xFD\x7B\xBF\xA9\xFD\x03\x00\x91\xD9\x15\x00")) #Finding pattern
	hex_value = int(hex_value, 0)
	fh.seek(hex_value, 0)
	fh.write(b"\xE0\x03\x00\x32\xC0\x03\x5F\xD6") #Applying AMFI patch
	fh.close()
